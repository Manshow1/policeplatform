function getEDbicycleAlermMessage() {
            ...
            $.ajax({
                type:"post",
                url:ival+"getEDbicycleAlermMessage",
                data:{"StartDate":s,"EndDate":e,"shebei":sh},
                dataType:"json",
                ...
                success:function(datas) {
                    ...
                    document.getElementById("td0009").option.value=json[n].state;
                    ...
                    document.getElementById("td0109").option.value=json[n].state;
                    ...
                    document.getElementById("td0209").option.value=json[n].state;
                    ...
                    document.getElementById("td0309").option.value=json[n].state;
                    ...
                    document.getElementById("td0409").option.value=json[n].state;
                    ...
                    document.getElementById("td0509").option.value=json[n].state;
                    ...
                    document.getElementById("td0609").option.value=json[n].state;
                    ...
                    document.getElementById("td0709").option.value=json[n].state;
                    ...
                    document.getElementById("td0809").option.value=json[n].state;
                    ...
                    document.getElementById("td0909").option.value=json[n].state;
                    ...
                    document.getElementById("td1009").option.value=json[n].state;
                    ...
                    document.getElementById("td1109").option.value=json[n].state;
                    ...
                    document.getElementById("td1209").option.value=json[n].state;
                    ...
                    document.getElementById("td1309").option.value=json[n].state;
                    ...
                    document.getElementById("td1409").option.value=json[n].state;
        ...
        var int=self.setInterval("getEDbicycleAlermMessage()",1*1000);
        function onBtn() {
