    ...
    //     script.src ="http://api.map.baidu.com/api?v=2.0&ak=Iw8Gl0lbmiS7YGAk3I1fPnYHSFSfd9E6&callback=init";
    ...
    // window.onload = loadJScript;  //异步加载地图
        ...
        function ObjMarker(locateType, description, lng, lat, uploadTime)    {
        ...
        function studentSearch () {
            ...
            $.ajax({
                ...
                success:function(datas) {
                    ...
                    showMap("allmap", 116.404, 39.915, markerArray);
