 ...
 *
 */
public class EbicycleLoginListener implements ServletContextListener{
	/**
	 * 
	 */
	public EbicycleLoginListener() {
	...
	public void contextInitialized(ServletContextEvent arg0) {
        ...
        timer.schedule(new EbicycleLoginTask(arg0.getServletContext()), date, period);
        //在 指定的date时刻执行task, 仅执行一次
        //timer.schedule(new DelFileTask(arg0.getServletContext()), date);
        arg0.getServletContext().log("已经添加电动车登录到任务调度表");
	}
