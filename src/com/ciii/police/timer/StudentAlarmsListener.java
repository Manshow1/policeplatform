 ...
 *
 */
public class StudentAlarmsListener implements ServletContextListener{
	/**
	 * 
	 */
	public StudentAlarmsListener() {
	...
	public void contextInitialized(ServletContextEvent arg0) {
        ...
        timer.schedule(new StudentAlarmsTask(arg0.getServletContext()), date, period);
        //在 指定的date时刻执行task, 仅执行一次
        //timer.schedule(new DelFileTask(arg0.getServletContext()), date);
        arg0.getServletContext().log("已经添加学生报警信息到任务调度表");
	}
