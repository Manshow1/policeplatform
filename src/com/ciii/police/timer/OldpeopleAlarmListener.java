 ...
 *
 */
public class OldpeopleAlarmListener implements ServletContextListener{
	/**
	 * 
	 */
	public OldpeopleAlarmListener() {
	...
	public void contextInitialized(ServletContextEvent arg0) {
        ...
        timer.schedule(new OldpeopleAlarmTask(arg0.getServletContext()), date, period);
        //在 指定的date时刻执行task, 仅执行一次
        //timer.schedule(new DelFileTask(arg0.getServletContext()), date);
        arg0.getServletContext().log("已经添加老人报警信息到任务调度表");
	}
