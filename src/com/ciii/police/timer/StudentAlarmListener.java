 ...
 *
 */
public class StudentAlarmListener implements ServletContextListener{
	/**
	 * 
	 */
	public StudentAlarmListener() {
	...
	public void contextInitialized(ServletContextEvent arg0) {
        ...
        timer.schedule(new StudentAlarmTask(arg0.getServletContext()), date, period);
