 ...
 *
 */
public class PolicemanLoginListener implements ServletContextListener{
	/**
	 * 
	 */
	public PolicemanLoginListener() {
	...
	public void contextInitialized(ServletContextEvent arg0) {
        ...
        timer.schedule(new PolicemanLoginTask(arg0.getServletContext()), date, period);
        //在 指定的date时刻执行task, 仅执行一次
        //timer.schedule(new DelFileTask(arg0.getServletContext()), date);
        arg0.getServletContext().log("已经添加警员登录到任务调度表");
	}
